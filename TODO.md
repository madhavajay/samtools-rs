...
- [x] Pin `htslib-rs/` to a known-green commit when Phase 0 lands. Current pin: `9cf30b3fd17d18bbb5c1209c60374ff79eab859d` (pileup iterator API + `PileupOptions` (flag/mapq/overlap/orphan) + `PileupRead.qpos_quality` + smart overlap removal for TODO-NEXT #1; prior pins: `e25f3929`, `5b25622`, `da4d3319`, `6bd6fb0`, `88bd29f`).
