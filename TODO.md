...
- [x] Pin `htslib-rs/` to a known-green commit when Phase 0 lands. Current pin: `e25f39299e3821b6343204fcbf9d417e0a1a4a88` (pileup iterator API + `PileupOptions` + `PileupRead.qpos_quality` for TODO-NEXT #1; prior pins: `5b25622` options, `da4d3319` pileup API, `6bd6fb0` post-PR-#5, `88bd29f` at Phase 0).
