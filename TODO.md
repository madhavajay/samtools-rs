...
- [x] Pin `htslib-rs/` to a known-green commit when Phase 0 lands. Current pin: `5b25622726f767f7a1af564bcd815ec9ed7a1d71` (public multi-input pileup iterator API + `PileupOptions` flag/mapq filtering for TODO-NEXT #1; prior pins: `da4d3319` pileup API, `6bd6fb0` post-PR-#5, `88bd29f` at Phase 0).
